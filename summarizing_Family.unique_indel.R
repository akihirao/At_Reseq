#summarizing_Family.unique_indel.R
...
input_indels_file <- paste(category,".family.unique_indels_list.txt",sep="")
...
input_indels_file.filtered <- paste(category,".family.unique_indels_list.filtered.txt",sep="")
...
output.no_unique.indel <- rbind(family.no_unique_indels, family.no_unique_indels.filtered)
row.names(output.no_unique.indel) <- c("no.unique.indels","no.unique.indels.filtered")


print(output.no_unique.indel)
write.table(output.no_unique.indel, "summary.no_indel.txt",quote=F)