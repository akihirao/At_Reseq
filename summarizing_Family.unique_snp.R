#summarizing_Family.unique_snp.R
...
input_snps_file <- paste(category,".family.unique_snps_list.txt",sep="")
...
input_snps_file.filtered <- paste(category,".family.unique_snps_list.filtered.txt",sep="")
...
output.no_unique.snp <- rbind(family.no_unique_snps, family.no_unique_snps.filtered)
row.names(output.no_unique.snp) <- c("no.unique.snps","no.unique.snps.filtered")


print(output.no_unique.snp)
write.table(output.no_unique.snp, "summary.no_snp.txt",quote=F)